    ...
    return couponResponse.data.map((coupon) => ({
        ...
        variant:{
            ...
            product: {
                ...
                name: coupon.attributes.variant.data.attributes.product.data.attributes.name,
                type: coupon.attributes.variant.data.attributes.product.data.attributes.type,
                image: getUrlFromImage(coupon.attributes.variant.data.attributes.product.data.attributes.image)
            },
        },
