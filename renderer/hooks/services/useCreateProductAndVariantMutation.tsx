...
export default function useCreateProductAndVariantMutation() {
  ...
  return useMutation(async ({data,variants,defaultVariantIndex}: IProps) => {
    const res = await strapi.create(getProductsQueryKey(),data) as ISingleFixedNativeResponse<IProductPayload>;
    console.log(
