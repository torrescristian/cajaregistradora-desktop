        ...
        <section className="w-full">
            ...
            <dialog ref={ref} className="modal-box">
                <div className="w-full flex flex-col p-5 gap-10">
                    <p className="text-xl font-bold whitespace-nowrap text-center">Seguro que quieres eliminar esta promo?</p>
                    <div className="flex flex-row w-full gap-5 justify-end">
                        <button className='btn btn-error' onClick={handleClickConfirmDeletePromo}>Eliminar</button>
                        <button className='btn btn-primary' onClick={() => ref.current?.close()}>Cancelar</button>
                    </div>
                </div>
            </dialog>
        </section>
