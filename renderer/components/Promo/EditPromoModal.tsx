...
import { ICategoryAndQuantity, IPromo, IVariantAndQuantity } from '@/interfaces/IPromo';
...
import useUpdatePromo from '@/hooks/services/useUpdatePromo';
        ...
        <section className="w-full">
            ...
            <dialog ref={ref} className=" items-end bg-neutral p-10">
                <form>
                    ...
                    <button className='btn btn-success' onClick={handleSubmitUpdatePromo}>Actualizar</button>
                </form>
