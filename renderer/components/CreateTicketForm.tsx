...
export const CreateTicketForm = ({ order, isEditing, handleToggleEdit }: IProps) => {
    ...
    return (
        <form className="flex w-full flex-col gap-5" onSubmit={handleSubmit(handleSubmitCreateTicket)}>
            ...
            <div className="flex flex-col">
                ...
                <datalist className="flex flex-col gap-4">
                    ...
                    {order.address ? (
                        <p className="flex flex-row items-center gap-3 ">
                            <MapPinIcon className="w-5 inline text-stone-500" /> {order.address}
                        </p>
                    ) : null}
                    {order.phoneNumber ? (
                        <p className="flex flex-row items-center gap-3">
                            <DevicePhoneMobileIcon className="w-5 inline  text-stone-500" /> {order.phoneNumber}
                        </p>
                    ) : null}
