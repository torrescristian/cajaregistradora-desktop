...
import { getAdditionalDetails, getCartItems, getClientId, getClientName, getClientPhone, getSubtotalPrice, getTotalAmount, useCartStore } from "@/contexts/CartStore";
...
export const ConfirmOrder = () => {
    ...
    return (
        <section>
            ...
            <dialog ref={ref} className="bg-base-300 shadow-md shadow-neutral-content p-10">
