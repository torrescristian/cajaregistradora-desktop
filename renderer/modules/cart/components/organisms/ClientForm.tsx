...
import FormField from '@/modules/common/components/molecules/FormFieldText';
  ...
  return (
    <section className="bg-red w-full sm:w-96">
      ...
      <div className="flex flex-row w-full justify-between">
        <RenderIf condition={client?.name}>
          <section className="flex flex-row w-full justify-between gap-3 pt-1 pb-3 items-center">
            <div className="flex flex-col">
              <p className="opacity-60 text-xs">Cliente Seleccionado: </p>
        ...
        <RenderIf condition={!client?.name}>
          <section className="flex flex-row gap-4 items-center w-full justify-between">
